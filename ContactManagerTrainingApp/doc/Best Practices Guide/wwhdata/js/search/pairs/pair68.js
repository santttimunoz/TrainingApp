...
x.t("policyperiodquery","query.make");
x.t("policyperiodquery","find");
x.t("stops","soon");
...
x.t("policyperiodquery.select","result.empty");
x.t("policyperiodquery.select","print");
x.t("result.empty","//");
x.t("recommendation","applies");
x.t("value","count");
x.t("value","empty");
x.t("document.linktothisurlform.urlfield","text_val.focus");
x.t("periods","policyperiodquery.empty");
x.t("periods","result.count");
x.t("periods","print");
x.t("periods","policyperiodquery.count");
x.t("periods","var");
x.t("builder","apis");
x.t("builder","results");
x.t("builder","api");
...
x.t("result","fetch");
x.t("result","objects");
x.t("result","policyperiodquery.select");
x.t("result","query");
x.t("result","object");
x.t("policyperiod","//");
...
x.t("//","result");
x.t("returns","gosu");
x.t("policyperiodquery.count","empty");
x.t("var","text_val=eval");
x.t("var","policyperiodquery");
x.t("var","result");
x.t("object","uses");
x.t("object","fetched");
x.t("object","var");
