...
x.t("policly","query");
x.t("(policly.policynumber)","icount");
x.t("prints","error");
...
x.t("outer","find");
x.t("revision","compression");
x.t("revision-dependent","entity");
x.t("loads","data");
x.t("54-123456","claim");
x.t("occurs","example");
...
x.t("defined","contain");
x.t("equals","null");
x.t("policyperiod","p.policynumber");
x.t("policyperiod","entity");
x.t("p.policynumber","==");
x.t("p.policynumber","null");
x.t("read-only","until");
...
x.t("absent","notation");
x.t("print","(policly.policynumber)");
x.t("print","end");
x.t("print","query");
x.t("print","claim.claims");
x.t("above","looks");
