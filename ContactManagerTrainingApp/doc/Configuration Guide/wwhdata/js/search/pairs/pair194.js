...
x.t("case","guidewire");
x.t("case","typelists");
x.t("modifications","coverage");
x.t("choose","override");
x.t("activities","example");
x.t("prioritized","ones");
x.t("pctl_","table-name");
x.t("pctl_","typelist-name");
