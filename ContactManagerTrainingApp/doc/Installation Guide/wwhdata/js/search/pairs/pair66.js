...
x.t("policycenterstartuppageep","file");
x.t("policycenterstartuppageep","resp.sendredirect");
x.t("gsrc","click");
...
x.t("entry","page");
x.t("testing","form");
x.t("http://localhost:8080/pc/service/ssosaml","method=");
...
x.t("action=","http://localhost:8080/pc/service/ssosaml");
x.t("input","action=");
x.t("input","type=");
...
x.t("policycenterstartuppage","authenticationrequired");
...
x.t("click","select");
x.t("click","ok");
x.t("enter","policycenterstartuppageep");
...
x.t("pcstartuppageep","policycenterstartuppageep");
x.t("pcstartuppageep",".do");
x.t("page","testing");
x.t("page","error");
...
x.t("registry","open");
x.t("registry","click");
x.t("location","policycenterstartuppage");
