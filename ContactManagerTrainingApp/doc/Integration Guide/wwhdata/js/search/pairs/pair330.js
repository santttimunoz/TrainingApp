...
x.t("file","policycenter/configuration/config/servlets.xml");
...
x.t("url","path");
x.t("url","http://localhost:port/pc/service/test");
x.t("url","checking");
x.t("url","string");
x.t("url","entire");
x.t("url","syntax");
...
x.t("url","substrings");
x.t("url","matches");
x.t("url","http://localhost:8080/pc/service");
x.t("url","protocol");
...
x.t("http://localhost:port/pc/service/test","change");
x.t("http://localhost:port/pc/service/test","message");
x.t("stored","client");
...
x.t("legacy","class");
x.t("store","session");
x.t("http://localhost:8080/pc/service/test1/my_magic_subfolder_one_level_down","http://localhost:8080/pc/service/test2/my_magic_subfolder_one_level_down");
x.t("http://localhost:8080/pc/service/test2/my_magic_subfolder_one_level_down","http://localhost:8080/pc/service/test3/my_magic_subfolder_one_level_down");
x.t("error","return");
x.t("error","occurred");
x.t("error","401");
x.t("prompt","gwpc");
...
x.t("message","http");
x.t("message","request");
x.t("http://localhost:8080/pc/service","/test/");
...
x.t("urls","start");
x.t("urls","servlet");
x.t("urls","http://localhost:8080/pc/service/test1/my_magic_subfolder_one_level_down");
x.t("urls","word");
x.t("urls","described");
x.t("query","path");
x.t("query","string");
...
x.t("policycenter/configuration/config/servlets.xml","add");
x.t("/servlets","add");
x.t("meaning","symbol");
