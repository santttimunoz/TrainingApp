...
x.t("simple","example");
x.t("simple","typecode");
x.t("go","policycenter/modules/configuration/config/typelists/mapping/typecodemapping.xml");
x.t("entry","contains");
x.t("check","printing");
x.t("meanings","indicate");
x.t("policycenter/modules/configuration/config/typelists/mapping/typecodemapping.xml","file");
x.t("directly","page");
