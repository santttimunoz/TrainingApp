...
x.t("type","called");
x.t("however","sure");
x.t("policy1.getstate","==");
x.t("policy1.getstate",".equals");
x.t("claim.getstate","returns");
x.t("policystate","want");
x.t("entities","two");
x.t("link","directly");
x.t("==","double");
x.t("==","policy2.getstate");
x.t("==","policystate.tc_open.get");
x.t("want","compare");
x.t("getting","static");
...
x.t("policy2.getstate","policy.getstate");
x.t("policy2.getstate","careful");
x.t("policystate.tc_open.get","policy1.getstate");
x.t("policystate.tc_open.get","following");
x.t(".equals","policystate.tc_open.get");
x.t(".equals","policy2.getstate");
x.t(".equals","(policystate.tc_open)");
x.t("guide","integration");
x.t("sure","reference");
x.t("directly","page");
x.t("test","equality");
x.t("text_val.focus","text_val.select");
x.t("name","policy.getstate");
x.t("text_val=eval","document.linktothisurlform.urlfield");
x.t("osgi","support");
x.t("(policystate.tc_open)","instead");
x.t("policycenter","integration");
x.t("error","occurred");
x.t("suppose","code");
x.t("syntax","policy.getstate");
...
x.t("code","compares");
x.t("typecodes","policy1.getstate");
