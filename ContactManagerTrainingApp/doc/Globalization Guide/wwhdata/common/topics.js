...
else if (Guidewire_TopicMatch(TOPIC,"System Table Localization") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_db_column.11.5.html") ) { return "localization_db_column.11.5.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Localizing PolicyCenter Workflow") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_workflow.12.2.html") ) { return "localization_workflow.12.2.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Names in PolicyCenter") && Guidewire_FMSourceFileMatch(SRCFILE,"name_config.16.2.html") ) { return "name_config.16.2.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"PolicyCenter Base Configuration Currencies") && Guidewire_FMSourceFileMatch(SRCFILE,"currency.20.2.html") ) { return "currency.20.2.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Addresses in PolicyCenter") && Guidewire_FMSourceFileMatch(SRCFILE,"address_config.22.2.html") ) { return "address_config.22.2.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Configuring Search in the PolicyCenter Database") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_sorting.24.5.html") ) { return "localization_sorting.24.5.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Configuring Sort in the PolicyCenter Database") && Guidewire_FMSourceFileMatch(SRCFILE,"localization_sorting.24.8.html") ) { return "localization_sorting.24.8.html";}
