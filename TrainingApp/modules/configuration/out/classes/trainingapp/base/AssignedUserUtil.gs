...
class AssignedUserUtil {
  ...
  */
  ...
  public static function selectLeastBusyUser(ABContactNeedingReassignment: ABContact): void {
    ...
    if ((ABContactNeedingReassignment typeis ABCompanyVendor) && (ABContactNeedingReassignment.AssignedUser.DisplayName != "Bruce Baker")) {
      gw.api.util.LocationUtil.addRequestScopedInfoMessage(displaykey.Ext.UINotification.InfoMessage.BruceBaker)
    }
  }
